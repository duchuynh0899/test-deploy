 ...
 * @author longn
 */
public class ForgotPass_InputNewPassServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ForgotPass_InputNewPassServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ForgotPass_InputNewPassServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (pass == null && repass == null) {
            response.sendRedirect("forgotPass_InputNewPass.jsp");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("pass") != null && request.getParameter("repass") != null) {
            String pass = request.getParameter("pass");
            String repass = request.getParameter("repass");
            String username = request.getSession().getAttribute("email").toString();
