...
public class AuthenticateServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("inputCode") == null) {
            ...
            sm.SendConfirmMail(code, (String) request.getAttribute("email"));
            //   adb.insert(a);
            request.getSession().setAttribute("authenticationCode", code); // add to request
            response.sendRedirect("authentication.jsp");
        } else {
            if (Integer.parseInt(request.getSession().getAttribute("authenticationCode").toString()) == Integer.parseInt(request.getParameter("inputCode"))) {
